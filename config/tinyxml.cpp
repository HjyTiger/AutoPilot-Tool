...
TiXmlCustomDeclaration::TiXmlCustomDeclaration( const char * _name )
	: TiXmlElement( _name )
{
...
#ifdef TIXML_USE_STL
TiXmlCustomDeclaration::TiXmlCustomDeclaration(	const std::string& _name )
	: TiXmlElement( _name )
{
...
TiXmlCustomDeclaration::TiXmlCustomDeclaration( const TiXmlCustomDeclaration& copy )
	: TiXmlElement( copy.value )
{
	copy.CopyTo( this );	
}


void TiXmlCustomDeclaration::operator=( const TiXmlCustomDeclaration& copy )
{
	Clear();
	copy.CopyTo( this );
}

TiXmlNode* TiXmlCustomDeclaration::Clone() const
{
	TiXmlCustomDeclaration* clone = new TiXmlCustomDeclaration("");
	if ( !clone )
		return 0;
...
void TiXmlCustomDeclaration::Print( FILE* cfile, int depth ) const
{
	fprintf( cfile, "<?%s", value.c_str() );
...
void TiXmlCustomDeclaration::StreamOut( TIXML_OSTREAM * stream ) const
{
	(*stream) << "<?" << value;
...
/*void TiXmlCustomDeclaration::CopyTo( TiXmlCustomDeclaration* target ) const
{
	TiXmlNode::CopyTo( target );
