...
class TiXmlCustomDeclaration : public TiXmlElement
{
public:
	/// Construct an empty declaration.
	//TiXmlCustomDeclaration()   : TiXmlElement( TiXmlNode::DECLARATION ) {}

#ifdef TIXML_USE_STL
	/// Constructor.
	TiXmlCustomDeclaration(	const std::string& _name );
#endif

	/// Construct.
	TiXmlCustomDeclaration(	const char* _name );

	TiXmlCustomDeclaration( const TiXmlCustomDeclaration& copy );
	void operator=( const TiXmlCustomDeclaration& copy );

	virtual ~TiXmlCustomDeclaration()	{}
...
//	virtual const TiXmlCustomDeclaration* ToDeclaration() const { return this; } ///< Cast to a more defined type. Will return null not of the requested type.
	//virtual TiXmlCustomDeclaration*       ToDeclaration()       { return this; } ///< Cast to a more defined type. Will return null not of the requested type.

protected:
	//void CopyTo( TiXmlCustomDeclaration* target ) const;
	// used to be public
	#ifdef TIXML_USE_STL
	//    virtual void StreamIn( TIXML_ISTREAM * in, TIXML_STRING * tag );
	#endif
